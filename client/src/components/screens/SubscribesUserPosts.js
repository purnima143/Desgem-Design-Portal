                   ...
                   return(
                       ...
                       <h5 className="title">{item.title} {item.postedBy._id == state._id 
                            ...
                            <form onSubmit={(e)=>{
                                ...
                                <p style={{fontSize:"14px", marginTop:"10px"}}>{item.body}</p>
                                {
                                    item.comments.map(record=>{
                                        return(
                                        <h6 key={record._id}  style={{fontSize:"1rem"}}><span style={{fontWeight:"700", color:"#33691e"}}>{record.postedBy.name}</span> {record.text}</h6>
                                        )
                                    })
                                }
